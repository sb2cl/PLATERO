...
if ~isempty(plottype)
    ...
    elseif strcmp(plottype,'boxplot')
        subplot(221)
        histogram(Gcoeffs.coef1,'FaceColor','b'), grid on,
        xlabel('b_1'), ylabel('freq.'), title('Hisogram b_1')
        subplot(222)
        ...
        subplot(223),
        histogram(Gcoeffs.coef2,'FaceColor','b'), grid on,
        xlabel('b_2'),ylabel('freq.'),
        title('Hisogram b_2')
        subplot(224),
